...
INSERT INTO owners (ID, owner_name)
VALUES (1, 'Sally'),
    (2, 'Charles'),
    (3, 'Angela'),
    (4, 'Kelly'),
...
INSERT INTO pet_names (id, owner_id, pet_name, type)
VALUES (10, 1, 'Zeus', 'Dog'),
    (11, 1, 'Fido', 'Dog'),
    (12, 2, 'Kevin', 'Dog'),
    (13, 3, 'Sprinkles', 'Cat'),
    (14, 4, 'Jumper', 'Cat'),
...
INSERT INTO pet_names_new (ID, owner_id, service_id, pet_name, type)
VALUES (10, 1, 22, 'Zeus', 'Dog'),
    (11, 1, 22, 'Fido', 'Dog'),
    (12, 2, 22, 'Kevin', 'Dog'),
